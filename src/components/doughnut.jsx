...
function AppDountChart(props) {
  const loginData = useSelector(state => state.appData);
  ...
  return (
    <div className="main-doughnut-div">
      <DonutChart selectedOffset={false} colors={colors} data={data} className = "newclass"/>{" "}
